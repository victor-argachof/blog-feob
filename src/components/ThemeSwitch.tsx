    ...
    >
      <div
        className={cx(
          ...
          "bg-transparent",
          // checked
          "group-data-[state=checked]:bg-indigo-50 group-data-[state=checked]:text-primary dark:group-data-[state=checked]:bg-indigo-500/20 dark:group-data-[state=checked]:text-primary",
          // focus
          focusRing,
        )}
      >
